-- local Snacks.picker = require("telescope.builtin")
-- local Snacks.picker = Snacks.picker
...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(event)
    ...
    map("gsd", Snacks.picker.lsp_symbols, "Open Document Symbols")

    -- Fuzzy find all the symbols in your current workspace.
    --  Similar to document symbols, except searches over your entire project.
    map("gsw", Snacks.picker.lsp_workspace_symbols, "Open Workspace Symbols")
