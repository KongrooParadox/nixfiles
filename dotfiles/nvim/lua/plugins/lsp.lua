    ...
    config = function()
      ...
      lsp.on_attach(function(_, bufnr)
        ...
        vim.keymap.set(
          ...
          "<leader>rn",
          vim.lsp.buf.rename,
          { buffer = bufnr, remap = false, desc = "LSP: [R]e[n]ame" }
        )
        vim.keymap.set(
          "n",
          "<leader>ca",
        ...
        vim.keymap.set(
          ...
          { buffer = bufnr, remap = false, desc = "LSP: Diagnostics [O]pen [F]loat" }
        )
        ...
        vim.keymap.set(
          ...
          { buffer = bufnr, remap = false, desc = "LSP: Type [D]efinition" }
        )
        vim.keymap.set(
          "n",
          "<leader>ds",
        ...
        vim.keymap.set(
          ...
          { buffer = bufnr, remap = false, desc = "LSP: [G]oto [D]eclaration" }
        )
        vim.keymap.set(
          "n",
          "<leader>wa",
          vim.lsp.buf.add_workspace_folder,
          { buffer = bufnr, remap = false, desc = "LSP: [W]orkspace [A]dd Folder" }
        )
        vim.keymap.set(
          "n",
          "<leader>wr",
          vim.lsp.buf.remove_workspace_folder,
          { buffer = bufnr, remap = false, desc = "LSP: [W]orkspace [R]emove Folder" }
        )
